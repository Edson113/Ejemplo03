// Ejemplo_Moanso.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
// Ingresa n personas (nombres, edad, estatura) a una lista enlazada doble y
// muÃ©stralos hacia atrÃ¡s empezando por el Ãºltimo. Las personas se registran al final
// de la listaDoble.
